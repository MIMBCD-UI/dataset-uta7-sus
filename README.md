...
[![MIT](https://flat.badgen.net/github/license/MIMBCD-UI/dataset-uta7-sus)](https://github.com/MIMBCD-UI/dataset-uta7-sus/blob/master/LICENSE)
...
[![HitCount](http://hits.dwyl.io/MIMBCD-UI/dataset-uta7-sus.svg)](http://hits.dwyl.io/MIMBCD-UI/dataset-uta7-sus)
...
```
git clone git@github.com:MIMBCD-UI/dataset-uta7-sus.git
```
...
For more information about the [MIMBCD-UI](https://MIMBCD-UI.github.io/) project just follow the [link](https://github.com/MIMBCD-UI/meta). Pieces of information about details of this *dataset* are also in a [wiki](https://github.com/MIMBCD-UI/dataset-uta7-sus/wiki).
