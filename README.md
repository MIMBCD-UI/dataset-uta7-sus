<meta http-equiv="refresh" content="0; url='https://mimbcd-ui.github.io/dataset-uta7-sus/web/index.html'" />
...
```bash
git clone https://github.com/MIMBCD-UI/dataset-uta7-sus.git
```
...
Either as something that seems missing or any need for support, just open a [new issue](https://github.com/MIMBCD-UI/dataset-uta7-sus/issues/new). Regardless of being a simple request or a fully-structured feature, we will do our best to understand them and, eventually, solve them.
